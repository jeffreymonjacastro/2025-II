...
int main(int argc, char *argv[]) {
  ...
  // 1. Genere un array en el maestro de tamaño igual a la cantidad total de procesos
  if (rank == 0) {
  ...
  // 2. Distribuya (scatter) loe elementos del array uno a cada proceso
  ...
  // 4. Recolecte (Gather) los resultados parciales por proceso en el array original del maestro
